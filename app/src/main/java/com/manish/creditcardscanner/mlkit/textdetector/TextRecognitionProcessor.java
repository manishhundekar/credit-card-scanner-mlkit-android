...
public class TextRecognitionProcessor extends VisionProcessorBase<Text> {
  ...
  public TextRecognitionProcessor(
    ...
    super(context);
    shouldGroupRecognizedTextInBlocks = shouldGroupRecognizedTextInBlocks(context);
    showLanguageTag = showLanguageTag(context);
    showConfidence = shouldShowTextConfidence(context);
